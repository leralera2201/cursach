...
public class CategoryWEBController {
    ...
    String create(Model model, @ModelAttribute("categoryForm") CategoryForm categoryForm) {
        ...
        boolean vn = validation.validateName(categoryForm.getCategory_name());
        boolean vm = validation.validateInt(categoryForm.getCategory_mark());
        boolean vnt = validation.validateInt(categoryForm.getMore_than());
        if (vn && vm && vnt) {
