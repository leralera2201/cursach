...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        ...
        <div class="form-group">
            <label>Tourist</label>
            <@spring.formSingleSelect "participationInCompetitionForm.tourist", mavs, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Competition</label>
            <@spring.formSingleSelect "participationInCompetitionForm.competition", mavs2, "class='form-control'"/>
        </div>
