...
<h3 class="text-center pt-4 pb-2">Category List</h3>
<div class="container text-center">
    <div class="input-group mb-3 form-style" style="display: flex; justify-content: center; align-items: center">
        <div class="input-group-prepend ">
            <button class="btn btn-outline-secondary dropdown-toggle " type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Find  category by name </button>
        ...
        <form name="search" class="col-6" action="" style="display: flex" method="POST">
    ...
    <div>
        <a href="/web/category/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by mark</a>
        <a href="/web/category/list" class="btn btn-outline-secondary mb-4">Undo</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tr class="table-secondary">
            ...
            <th scope="col">More than(days)</th>
        ...
        <#list categories as category>
            <tr>
                ...
                <td>${category.category_mark}</td>
                <td>${category.more_than}</td>

                <td><a href="delete/${category.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${category.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
