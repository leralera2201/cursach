...
<h3 class="text-center pt-4 pb-2">Part In Group List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/tourist-in-group/sorted-list-by-group" class="btn btn-outline-secondary mb-4">Sort table by group name</a>
        <a href="/web/tourist-in-group/sorted-list-by-tourist" class="btn btn-outline-secondary mb-4">Sort table by tourist name</a>
        <a href="/web/tourist-in-group/list" class="btn btn-outline-secondary mb-4 ml-2">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tbody>
        <#list touristInGroups as tig>
            <tr>
                <td>${tig?index + 1}</td>
                <td>${tig.group.group_name}</td>
                <td>${tig.tourist.nameandSurname}</td>

                <td><a href="delete/${tig.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${tig.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
