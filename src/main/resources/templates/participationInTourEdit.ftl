...
<div class="container">
    ...
    <form name="participationInTourForm" class="form" action="" method="POST" style="width: 600px">

        <div class="form-group">
            <label>Tourist</label>
            <@spring.formSingleSelect "participationInTourForm.tourist", mavs, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Tour</label>
            <@spring.formSingleSelect "participationInTourForm.tour", mavs2, "class='form-control'"/>
        </div>
