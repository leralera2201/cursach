...
<h3 class="text-center pt-4 pb-2">Tour Type List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/tour-type/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
        <a href="/web/tour-type/list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <#list tourTypes as tourType>
            <tr>
                <td>${tourType?index + 1}</td>
                <td>${tourType.type_name}</td>
                <td>${tourType.type_description}</td>
                <td><a href="delete/${tourType.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${tourType.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
            </tr>
        </#list>
        </tbody>
    </table>
