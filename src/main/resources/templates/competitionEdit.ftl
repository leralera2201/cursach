...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            ...
            <@spring.formInput "competitionForm.competition_name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Description</label>
            <@spring.formInput "competitionForm.description" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Competition date</label>
            <br>
            <small>The format is 'YYYY-MM-DD HH-mm'</small>
            <@spring.formInput "competitionForm.competition_date" "class='form-control'" "text"/>
        </div>

        <div class="form-group">
            <label>Section</label>
            <@spring.formSingleSelect "competitionForm.section", mavs, "class='form-control'"/>
        </div>
