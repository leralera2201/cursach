...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            <label>Surname</label>
            <@spring.formInput "touristForm.surname" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Name</label>
            <@spring.formInput "touristForm.name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Patronic</label>
            <@spring.formInput "touristForm.patronic" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Phone</label>
            <br>
            <small>The format is '380XXXXXXXXX' or '0XXXXXXXXX'</small>
            <@spring.formInput "touristForm.phone" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Birthday</label>
            <br>
            <small>The format is 'YYYY-MM-DD'</small>
            <@spring.formInput "touristForm.birthday" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Email</label>
            <@spring.formInput "touristForm.email" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Negative feature</label>
            <@spring.formInput "touristForm.negative_features" "class='form-control'" "text"/>
        </div>

        <div class="form-group">
            <label>Sex</label>
            <#assign options = { "A": "Man", "B": "Woman" } />
            <@spring.formSingleSelect "touristForm.sex" options "class='form-control'" />
        </div>
        <div class="form-group">
            <label>Physical data</label>
            <@spring.formInput "touristForm.physical_data" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Category</label>
            <@spring.formSingleSelect "touristForm.max_category", mavs, "class='form-control'"/>
        </div>
