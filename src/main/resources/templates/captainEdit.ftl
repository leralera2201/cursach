...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            <label>Surname</label>
            <@spring.formInput "captainForm.surname" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Name</label>
            <@spring.formInput "captainForm.name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Patronic</label>
            <@spring.formInput "captainForm.patronic" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Phone</label>
            <br>
            <small>The format is '380XXXXXXXXX' or '0XXXXXXXXX'</small>
            <@spring.formInput "captainForm.phone" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Birthday</label>
            <br>
            <small>The format is 'YYYY-MM-DD'</small>
            <@spring.formInput "captainForm.birthday" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Email</label>
            <@spring.formInput "captainForm.email" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Salary</label>
            <br>
            <small>The format is 'X' or 'X.X'.</small>
            <@spring.formInput "captainForm.Salary" "class='form-control'" "text"/>
        </div>
        ...
        <div class="form-group">
            ...
            <br>
            <small>The format is 'YYYY-MM-DD'</small>
            <@spring.formInput "captainForm.started_work_year" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Sex</label>
            <#assign options = { "A": "Man", "B": "Woman" } />
            <@spring.formSingleSelect "captainForm.sex" options "class='form-control'" />
        </div>
