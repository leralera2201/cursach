...
<h3 class="text-center pt-4 pb-2">Coach List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/coach/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
        <a href="/web/coach/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tr class="table-secondary">
            ...
            <th scope="col">Started work year</th>
        ...
        <#list coaches as coach>
            <tr>
                ...
                <td>${coach.tourist.patronic}</td>
                <td>${coach.speciality}</td>
                <td>${coach.started_work_year}</td>
                <td>${coach.salary}</td>


                <td><a href="delete/${coach.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${coach.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
