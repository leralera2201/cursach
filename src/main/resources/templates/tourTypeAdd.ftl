...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" >
        <div class="form-group">
            ...
            <@spring.formInput "tourTypeForm.type_name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Tour description</label>
            <@spring.formInput "tourTypeForm.type_description" "class='form-control'" "text"/>
        </div>
