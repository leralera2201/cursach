...
<h3 class="text-center pt-4 pb-2">Section List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/section/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
        <a href="/web/section/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <#list sections as section>
            <tr>
                ...
                <td>${section.captain.nameAndSurname}</td>


                <td><a href="delete/${section.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${section.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
