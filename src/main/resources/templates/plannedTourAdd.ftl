...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" >
        <div class="form-group">
            ...
            <@spring.formSingleSelect "plannedTourForm.tour", mavs, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Halt Schedule</label>
            <@spring.formInput "plannedTourForm.halt_schedule" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Break Schedule</label>
            <@spring.formInput "plannedTourForm.break_schedule" "class='form-control'" "text"/>
        </div>
