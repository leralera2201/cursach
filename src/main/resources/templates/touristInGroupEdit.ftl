...
<div class="container">
    ...
    <form name="touristInGroup" class="form" action="" method="POST" style="width: 600px">

        <div class="form-group">
            <label>Tourist</label>
            <@spring.formSingleSelect "touristInGroupForm.tourist", mavs, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Group</label>
            <@spring.formSingleSelect "touristInGroupForm.group", mavs2, "class='form-control'"/>
        </div>
