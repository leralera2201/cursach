...
<h3 class="text-center pt-4 pb-2">Sportsman List</h3>
<div class="container text-center">
    <div class="input-group mb-3 " style="display: flex; justify-content: center; align-items: center">
        ...
        <form name="search" class="col-6" style="display: flex" action="" method="POST">
            ...
            <input type="submit" class="btn btn-outline-secondary form-control col-2" value="Search"/>
        </form>
    </div>
    <div>
        <a href="/web/sportsman/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
        <a href="/web/sportsman/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <#list sportsmen as sportsman>
            <tr>
                <td>${sportsman?index + 1}</td>
                <td>${sportsman.tourist.nameandSurname}</td>
                <td>${sportsman.sport_kinds}</td>

                <td><a href="delete/${sportsman.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${sportsman.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
