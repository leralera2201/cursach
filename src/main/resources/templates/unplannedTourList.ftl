...
<head>
    <meta charset="UTF-8">
    <title>Unplanned Tour List</title>
...
<h3 class="text-center pt-4 pb-2">Unplanned Tour List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/unplanned-tour/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by date</a>
        <a href="/web/unplanned-tour/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tbody>
        <#list unplannedTours as unplannedTour>
            <tr>
                <td>${unplannedTour?index + 1}</td>
                <td>${unplannedTour.tour.tour_name}</td>
                <td>${unplannedTour.tour.tour_date}</td>


                <td><a href="delete/${unplannedTour.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${unplannedTour.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
