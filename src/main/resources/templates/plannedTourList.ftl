...
<h3 class="text-center pt-4 pb-2">Planned Tour List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/planned-tour/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by date</a>
        <a href="/web/planned-tour/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tr class="table-secondary">
            ...
            <th scope="col">Halt schedule</th>
            <th scope="col">Break schedule</th>
        ...
        <tbody>
        <#list plannedTours as plannedTour>
            <tr>
                <td>${plannedTour?index + 1}</td>
                <td>${plannedTour.tour.tour_name}</td>
                <td>${plannedTour.halt_schedule}</td>
                <td>${plannedTour.break_schedule}</td>
                <td>${plannedTour.tour.tour_date}</td>


                <td><a href="delete/${plannedTour.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${plannedTour.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
