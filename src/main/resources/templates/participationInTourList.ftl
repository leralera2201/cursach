...
<h3 class="text-center pt-4 pb-2">Part In Tour List</h3>
...
<#--        </div>-->
    ...
    <div>
        <a href="/web/participation-in-tour/sorted-list-by-tour" class="btn btn-outline-secondary mb-4">Sort table by tour name</a>
        <a href="/web/participation-in-tour/sorted-list-by-tourist" class="btn btn-outline-secondary mb-4">Sort table by tourist name</a>
        <a href="/web/participation-in-tour/list" class="btn btn-outline-secondary mb-4 ml-2">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tbody>
        <#list participationInTours as pit>
            <tr>
                <td>${pit?index + 1}</td>

                <td>${pit.tour.tour_name}</td>


                <td>${pit.tour.tour_date}</td>
                <td>${pit.tourist.nameandSurname}</td>

                <td><a href="delete/${pit.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${pit.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
