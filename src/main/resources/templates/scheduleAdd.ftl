...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            ...
            <@spring.formInput "scheduleForm.train_name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Description</label>
            <@spring.formInput "scheduleForm.description" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Started datetime</label>
            <br>
            <small>The format is 'YYYY-MM-DD HH-mm'</small>
            <@spring.formInput "scheduleForm.started_datetime" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Training time</label>
            <br>
            <small>In hours. The format is 'X' or 'X.Y'.</small>
            <@spring.formInput "scheduleForm.time" "class='form-control'" "text"/>
        </div>
        ...
        <div class="form-group">
            ...
            <@spring.formInput "scheduleForm.payment" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Place</label>
            <@spring.formInput "scheduleForm.place" "class='form-control'" "text"/>
        </div>

        <div class="form-group">
            <label>Group</label>
            <@spring.formSingleSelect "scheduleForm.group", mavs, "class='form-control'"/>
        </div>
