...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            ...
            <@spring.formInput "categoryForm.category_name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Category mark</label>
            <@spring.formInput "categoryForm.category_mark" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>More than(days)</label>
            <@spring.formInput "categoryForm.more_than" "class='form-control'" "text"/>
        </div>
