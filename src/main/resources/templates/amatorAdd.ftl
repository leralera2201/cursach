...
<div class="container">
    ...
    <form name="tourist" class="form" style="width: 600px" action="" method="POST" >

        <div class="form-group">
            <label>Tourist name and surname</label>
            <@spring.formSingleSelect "amatorForm.tourist", mavs, ""/>
        </div>
        <div class="form-group">
            <label>Hobbies</label>
            <@spring.formInput "amatorForm.hobbies" "" "text"/>
        </div>
