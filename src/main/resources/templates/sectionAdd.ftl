...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
            ...
            <div class="form-group">
                <label>Captain</label>
                <@spring.formSingleSelect "sectionForm.captain", mavs, "class='form-control'"/>
            </div>
            <div class="form-group">
                <label>Section name</label>
                <@spring.formInput "sectionForm.section_name" "class='form-control'" "text"/>
            </div>
            <div class="form-group">
                <label>Description</label>
                <@spring.formInput "sectionForm.description" "class='form-control'" "text"/>
            </div>
