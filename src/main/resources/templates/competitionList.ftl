...
<h3 class="text-center pt-4 pb-2">Competition List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/competition/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by date</a>
        <a href="/web/competition/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <#list competitions as competition>
            <tr>
                <td>${competition?index + 1}</td>
                <td>${competition.competition_name}</td>
                <td>${competition.description}</td>
                <td>${competition.competition_date}</td>
                <td>${competition.section.section_name}</td>

                <td><a href="delete/${competition.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${competition.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
