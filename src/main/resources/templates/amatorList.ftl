...
<h3 class="text-center pt-4 pb-2">Amator List</h3>
<div class="container text-center">
    ...
    <div>
        <a href="/web/amator/sorted-list" class="btn btn-outline-secondary mb-4">Sort table by name</a>
        <a href="/web/amator/list" class="btn btn-outline-secondary mb-4">Undo sort</a>
    </div>
    ...
    <table class="table table-hover pt-5">
        ...
        <tbody>
        <#list amators as amator>
            <tr>
                <td>${amator?index + 1}</td>
                <td>${amator.tourist.surname}</td>
                <td>${amator.tourist.name}</td>
                <td>${amator.hobbies}</td>


                <td><a href="delete/${amator.id}">
                        <button class="btn btn-outline-secondary">Delete</button>
                    </a></td>
                <td><a href="edit/${amator.id}"><button class="btn btn-outline-secondary">Edit</button></a></td>
