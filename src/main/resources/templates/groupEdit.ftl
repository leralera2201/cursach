...
<div class="container">
    ...
    <form name="tourist" class="form" action="" method="POST" style="width: 600px">
        <div class="form-group">
            <label>Captain</label>
            <@spring.formSingleSelect "groupForm.assigned_by", mavs3, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Coach</label>
            <@spring.formSingleSelect "groupForm.coach", mavs2, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Section</label>
            <@spring.formSingleSelect "groupForm.section", mavs, "class='form-control'"/>
        </div>
        <div class="form-group">
            <label>Group name</label>
            <@spring.formInput "groupForm.group_name" "class='form-control'" "text"/>
        </div>
        <div class="form-group">
            <label>Description</label>
            <@spring.formInput "groupForm.description" "class='form-control'" "text"/>
        </div>
